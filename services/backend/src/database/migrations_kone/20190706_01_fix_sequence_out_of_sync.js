module.exports = {
  up: async ({ context: queryInterface }) => {
    return queryInterface.sequelize.transaction(async transaction => {
      ...
      await queryInterface.sequelize.query(
        "SELECT setval('course_groups_id_seq', (SELECT MAX(id) FROM course_groups))",
        { transaction }
      )
      await queryInterface.sequelize.query(
        "SELECT setval('mandatory_course_labels_id_seq', (SELECT MAX(id) FROM mandatory_course_labels))",
        { transaction }
      )
