...
import { ProgrammeCoursesTab } from '@/pages/StudyProgramme/ProgrammeCoursesTab'
import { StudyProgrammeSelector } from '@/pages/StudyProgramme/StudyProgrammeSelector'
import { StudyTracksAndClassStatisticsTab } from '@/pages/StudyProgramme/StudyTracksAndClassStatisticsTab'
import { TagsTab } from '@/pages/StudyProgramme/TagsTab'
import { UpdateStatisticsTab } from '@/pages/StudyProgramme/UpdateStatisticsTab'
