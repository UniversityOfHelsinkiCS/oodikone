...
import { GradeDistributionChart } from '@/pages/CourseStatistics/CourseTab/SingleCourseStats/ResultTabs/tabs/charts/GradeDistributionChart'
import { PassRateChart } from '@/pages/CourseStatistics/CourseTab/SingleCourseStats/ResultTabs/tabs/charts/PassRateChart'
import { ChartSettings } from '@/pages/CourseStatistics/CourseTab/SingleCourseStats/ResultTabs/tabs/settings/ChartSettings'
import { TableSettings } from '@/pages/CourseStatistics/CourseTab/SingleCourseStats/ResultTabs/tabs/settings/TableSettings'
import { AttemptsTable } from '@/pages/CourseStatistics/CourseTab/SingleCourseStats/ResultTabs/tabs/tables/AttemptsTable'
import { StudentsTable } from '@/pages/CourseStatistics/CourseTab/SingleCourseStats/ResultTabs/tabs/tables/StudentsTable'
            ...
            .map(data => (
              <div key={data.name}>
                {settings.viewMode === 'STUDENTS' ? (
                  <StudentsTable
                    combineSubstitutions={combineSubstutitions}
