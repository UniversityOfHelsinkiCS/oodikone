...
const getColumns = (showDetails, showEnrollments, userHasAccessToAllStats, alternatives, separate) => {
  ...
  const columns = [
    ...
    {
      key: 'ENROLLMENTS_CONFIRMED',
      title: 'Confirmed',
      getRowVal: s => (s.rowObfuscated ? '5 or less students' : s.enrollmentsByState.CONFIRMED) || 0,
      getCellProps: s => defineCellColor(s),
      onlyInEnrollmentView: true,
    },
    {
      key: 'ENROLLMENTS_ABORTED_BY_STUDENT',
      title: 'Aborted by student',
      getRowVal: s => (s.rowObfuscated ? '5 or less students' : s.enrollmentsByState.ABORTED_BY_STUDENT) || 0,
      getCellProps: s => defineCellColor(s),
      onlyInEnrollmentView: true,
    },
    {
      key: 'ENROLLMENTS_ABORTED_BY_TEACHER',
      title: 'Aborted by teacher',
      getRowVal: s => (s.rowObfuscated ? '5 or less students' : s.enrollmentsByState.ABORTED_BY_TEACHER) || 0,
      getCellProps: s => defineCellColor(s),
      onlyInEnrollmentView: true,
    },
    {
      key: 'ENROLLMENTS_PROCESSING',
      title: 'Processing',
      getRowVal: s => (s.rowObfuscated ? '5 or less students' : s.enrollmentsByState.PROCESSING) || 0,
      getCellProps: s => defineCellColor(s),
      onlyInEnrollmentView: true,
    },
    {
      key: 'ENROLLMENTS_NOT_ENROLLED',
      title: 'Not enrolled',
      getRowVal: s => (s.rowObfuscated ? '5 or less students' : s.enrollmentsByState.NOT_ENROLLED) || 0,
      getCellProps: s => defineCellColor(s),
      onlyInEnrollmentView: true,
    },
    {
