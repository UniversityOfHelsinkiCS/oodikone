...
export const TableInfo = () => (
  <Alert severity="info" sx={{ my: 2 }} variant="outlined">
    <Box sx={{ display: 'grid', columnGap: 4, gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' } }}>
      <Box>
      ...
      <Box>
        ...
        <Typography sx={{ display: 'flex' }}>
          <span className="enrollment-label label-passive" style={{ margin: 'auto 0' }} />: Passive: Student did not
          enroll at all.
        </Typography>
        <Typography sx={{ display: 'flex' }}>
          <span className="enrollment-label label-none" style={{ margin: 'auto 0' }} />: Student has no enrollment, but
          also no study right for the semester.
        </Typography>
      </Box>
    </Box>
  </Alert>
