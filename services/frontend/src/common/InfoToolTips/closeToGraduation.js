export const closeToGraduationToolTips = `
  You can filter students by choosing a degree programme and/or a faculty. You can also select multiple programmes or faculties. Please note that if you select a faculty, only the degree programmes of that faculty will be shown.  
  ...
  - All bachelor’s programmes: 160 credits
  ...
  - Other master’s programmes: 85 credits
