export const updaterToolTips = {
  updaterSection: `
    ...
    **Update curriculums**: Updates all degree programmes and their curriculums. This takes a few minutes, and breaks the curriculum features for that time, so do not run in production unnecessarily.  
  ...
  refreshDataSection: `
    ...
    **Refresh degree programmes**: Refresh data for new degree programmes for basic and studytrack tabs (time consuming).  
