  ...
  cy.cs(parentEl)
    ...
    .then(initialMin => {
      cy.cs(parentEl)
        ...
        .invoke('val')
        .then(initialMax => {
          cy.cs(parentEl).cs('FilterRangeStart').find('input').clear()
          cy.cs(parentEl).cs('FilterRangeStart').find('input').type(minText)
          cy.cs(parentEl).cs('FilterRangeEnd').find('input').clear()
          cy.cs(parentEl).cs('FilterRangeEnd').find('input').type(maxText)
