        ...
        describe('Students tab', () => {
          ...
          it('Show grades on, Separate by semesters on', () => {
            const tableContents = [
              ...
              ['Kevät 2017', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
        ...
        describe('Students tab', () => {
          it('Show grades off, Separate by semesters off', () => {
            const tableContents = [
              ...
              ['2004-2005', null, 0, 0, 0, null, '–', '–'],
              ['2003-2004', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['2002-2003', null, 0, 0, 0, null, '–', '–'],
              ['2001-2002', null, 0, 0, 0, null, '–', '–'],
              ['2000-2001', null, 0, 0, 0, null, '–', '–'],
          ...
          it('Show grades off, Separate by semesters on', () => {
            const tableContents = [
              ...
              ['Kevät 2013', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2012', null, 4, 4, 0, null, '100.00 %', '0.00 %'],
              ['Kevät 2012', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2011', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2011', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2010', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2010', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2009', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2009', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2008', null, 1, 0, 1, null, '0.00 %', '100.00 %'],
              ['Kevät 2008', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2007', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2007', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2006', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2006', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2005', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['Kevät 2005', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2004', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2004', null, 1, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2003', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2003', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2002', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2002', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2001', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2001', null, 0, 0, 0, 0, '–', '–'],
              ['Syksy 2000', null, 0, 0, 0, 0, '–', '–'],
              ['Kevät 2000', null, 0, 0, 0, 0, '–', '–'],
          ...
          it('Show grades on, Separate by semesters off', () => {
            const tableContents = [
              ...
              ['2009-2010', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ...
              ['2004-2005', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['2003-2004', null, 1, 0, 0, 0, 0, 0, 1, 0, null, '100.00 %', '0.00 %'],
              ['2002-2003', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['2001-2002', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['2000-2001', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
          ...
          it('Show grades on, Separate by semesters on', () => {
            const tableContents = [
              ...
              ['Kevät 2013', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2012', null, 4, 0, 0, 0, 0, 3, 1, 0, null, '100.00 %', '0.00 %'],
              ['Kevät 2012', null, 1, 0, 0, 0, 0, 0, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2011', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2011', null, 1, 0, 0, 0, 0, 1, 0, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2010', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2010', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2009', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2009', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2008', null, 1, 1, 0, 0, 0, 0, 0, 0, null, '0.00 %', '100.00 %'],
              ['Kevät 2008', null, 1, 0, 0, 0, 0, 0, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2007', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2007', null, 1, 0, 0, 0, 0, 0, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2006', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2006', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2005', null, 1, 0, 0, 0, 0, 1, 0, 0, null, '100.00 %', '0.00 %'],
              ['Kevät 2005', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2004', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2004', null, 1, 0, 0, 0, 0, 0, 1, 0, null, '100.00 %', '0.00 %'],
              ['Syksy 2003', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2003', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2002', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2002', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2001', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2001', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Syksy 2000', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
              ['Kevät 2000', null, 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
