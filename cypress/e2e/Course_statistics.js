...
describe('Course Statistics tests', () => {
  describe('when using basic user', () => {
    ...
    it('Shows correct statistics when alternative courses are not combined', () => {
      cy.get('[data-cy="combine-alternatives-toggle"]').should('have.class', 'checked').click()
      cy.get('[data-cy="combine-alternatives-toggle"]').should('not.have.class', 'checked')
