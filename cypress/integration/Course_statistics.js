...
describe("Course Statistics tests", () => {
  ...
  it("Searching multiple courses having substitution mappings shows course statistics", () => {
    ...
    cy.contains(".courseNameCell", "Tietorakenteet ja algoritmit")
      .contains("TKT20001")
      .click();
    cy.contains(".courseNameCell", "Ohjelmoinnin perusteet").should(
      "not.exist"
    );
    cy.contains("TKT20001");
    cy.contains("58131"); // old mapped code
    ...
    cy.contains(".courseNameCell", "Ohjelmoinnin perusteet")
      .contains("TKT10002")
      .click();
...
*/
    ...
    it("Some features of Course Statistics are hidden for courseStatistics-users", () => {
      ...
      cy.get("[data-cy=access-groups-form]")
        .click()
        .contains("courseStatistics")
        .click();
