...
describe('Population Statistics tests', () => {
  ...
  describe('when using basic user', () => {
    ...
    it('Population statistics is usable on general level', () => {
      ...
      cy.wait(10000) // a bit hacky way, wait until ui is ready
    ...
    it('Credit Statistics, Statistics pane works', () => {
      ...
      cy.get("[data-cy='credit-stats-mean']").should('contain', '125.99')
      cy.get("[data-cy='credit-stats-stdev']").should('contain', '63.66')
      ...
      cy.get("[data-cy='credit-stats-q3']").should('contain', '169')
      cy.get("[data-cy='credit-stats-max']").should('contain', '339')
    })
  })
