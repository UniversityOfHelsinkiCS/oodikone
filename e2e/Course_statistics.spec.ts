      ...
      test.describe('Students tab', () => {
        ...
        test('Show grades on, Separate by semesters on', async ({ page }) => {
          const tableContents = [
            ...
            ['Syksy 2013', 0, 0, 0, 0, 0, 0, 0, 0, null, '–', '–'],
